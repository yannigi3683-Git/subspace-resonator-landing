...
const BandcampIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z"/></svg>
);
const SpotifyIcon = () => (
...
const DiscogsIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0zm0 2.034a9.966 9.966 0 0 1 9.966 9.966A9.966 9.966 0 0 1 12 21.966 9.966 9.966 0 0 1 2.034 12 9.966 9.966 0 0 1 12 2.034zm0 3.932A6.034 6.034 0 0 0 5.966 12 6.034 6.034 0 0 0 12 18.034 6.034 6.034 0 0 0 18.034 12 6.034 6.034 0 0 0 12 5.966zm0 2.034A4 4 0 0 1 16 12a4 4 0 0 1-4 4 4 4 0 0 1-4-4 4 4 0 0 1 4-4zm0 2a2 2 0 0 0-2 2 2 2 0 0 0 2 2 2 2 0 0 0 2-2 2 2 0 0 0-2-2z"/></svg>
);
const CalendarIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11zM9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2z"/></svg>
);
const LinktreeIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M13.736 5.853l4.005-4.117 2.325 2.38-4.2 4.005h5.908v3.305h-5.937l4.229 4.108-2.325 2.334-5.74-5.769-5.741 5.769-2.325-2.325 4.229-4.108H2.226V8.121h5.909l-4.2-4.005 2.324-2.38 4.005 4.117V0h3.472v5.853zM10.263 15.297h3.472V24h-3.472v-8.703z"/></svg>
);
const BeatportIcon = () => (
